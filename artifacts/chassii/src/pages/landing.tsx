      ...
      <div className="py-24 bg-white overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            {/* Left: copy */}
            <div>
              <div className="inline-flex items-center gap-2 bg-red-50 text-primary text-sm font-semibold px-4 py-2 rounded-full mb-6">
              ...
              <ul className="space-y-5 mb-10">
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-gray-900 font-semibold">Diagnose before you panic</p>
                    <p className="text-gray-500 text-sm mt-0.5">Describe a symptom and get likely causes ranked by probability — before you call the shop.</p>
                  </div>
                </li>
                <li className="flex items-start gap-4">
                  <div className="h-10 w-10 rounded-xl bg-red-50 flex items-center justify-center flex-shrink-0 mt-0.5">
                  ...
                  <div>
                    <p className="text-gray-900 font-semibold">Maintenance reminders that make sense</p>
                    <p className="text-gray-500 text-sm mt-0.5">Ask what's due at your mileage — and get interval recommendations specific to your chassis.</p>
                  </div>
                </li>
                <li className="flex items-start gap-4">
                  <div className="h-10 w-10 rounded-xl bg-red-50 flex items-center justify-center flex-shrink-0 mt-0.5">
                  ...
                  <div>
                    <p className="text-gray-900 font-semibold">Know your common issues</p>
                    <p className="text-gray-500 text-sm mt-0.5">Every platform has known gremlins. Your AI Mechanic surfaces them so you're never caught off guard.</p>
                  </div>
                </li>
              </ul>
              <Button
            ...
            <div className="relative">
              <div className="absolute -inset-4 bg-red-50 rounded-3xl blur-2xl pointer-events-none opacity-60" />
              <div className="relative bg-white rounded-3xl border border-gray-200 overflow-hidden shadow-xl">
                ...
                <div className="flex items-center gap-3 px-5 py-4 border-b border-gray-100 bg-gray-50">
                  ...
                  <div>
                    <p className="text-gray-900 font-semibold text-sm">AI Mechanic</p>
                    <p className="text-gray-500 text-xs">Knows your 1994 Toyota Supra</p>
                  </div>
                ...
                {/* Messages */}
                <div className="p-5 space-y-4 min-h-[320px] bg-white">
                  <div className="flex justify-end">
                    <div className="bg-primary text-white text-sm rounded-2xl rounded-br-sm px-4 py-2.5 max-w-[80%]">
                      My 2JZ has a slight ticking at idle when warm. Should I be worried?
                    </div>
                  </div>

                  <div className="flex items-start gap-3">
                    <div className="h-7 w-7 rounded-full bg-gray-100 flex items-center justify-center flex-shrink-0 mt-1">
                      <Wrench className="h-3.5 w-3.5 text-primary" />
                    </div>
                    <div className="bg-gray-100 text-gray-800 text-sm rounded-2xl rounded-bl-sm px-4 py-3 max-w-[85%] space-y-2">
                      <p>A warm ticking on the 2JZ-GTE is most commonly one of three things:</p>
                      <ol className="list-decimal list-inside space-y-1 text-gray-600">
                        <li><span className="text-gray-900 font-medium">VVT-i solenoid</span> — the most common culprit on high-mileage Supras. Cheap fix.</li>
                        <li><span className="text-gray-900 font-medium">Valve clearance</span> — check if you're past 60k since your last adjustment.</li>
                        <li><span className="text-gray-900 font-medium">Oil pressure</span> — less likely, but worth checking with a gauge.</li>
                      </ol>
                      <p className="text-gray-500 text-xs pt-1">I'd start with the solenoid screen. Want a step-by-step?</p>
                    </div>
                  </div>

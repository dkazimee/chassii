        ...
        {isLoading ? (
          ...
          posts.map(post => (
            <Link key={post.id} href={`/posts/${post.id}`}>
              <Card className="rounded-2xl border-gray-100 shadow-sm hover:shadow-md hover:border-gray-200 transition-all cursor-pointer group">
                <CardContent className="p-6 md:p-8 flex gap-6">
                  <div className="hidden sm:flex flex-col items-center gap-1 text-gray-400 group-hover:text-gray-600 transition-colors w-12 shrink-0">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-4 text-sm">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="font-medium text-gray-700">{post.author?.displayName}</span>
                      </div>
                      <div className="flex items-center gap-1.5 text-gray-500">
                        <MessageSquare className="h-4 w-4" /> {post.commentCount || 0} replies
                      </div>
                    </div>
                  </div>
                </CardContent>
